...
from sessions.views import ExerciseChart, RoutineList, RoutineDetail, ExerciseDetail, SessionCreate, SessionDetail, SessionDelete, ExerciseUpdate, RoutineUpdate
...
urlpatterns = [
    ...
    path('progress/<exercise_name>/', ExerciseChart.as_view(), name='progress_charts'),
