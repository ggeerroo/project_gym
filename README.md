# SESSIONS
#### [Video Demo](https://youtu.be/44cpGczggSc)
#### Description:
...
### IMPORTANT NOTE: 
At this stage you can only use this app if you run it locally from your computer and it's for personal use, which means that all the accounts created using your server will share the same information (e.g: Routines and Exercise updates). 
